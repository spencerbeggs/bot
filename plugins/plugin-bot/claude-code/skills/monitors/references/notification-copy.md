...
> House doctrine — not an upstream mirror. The `monitors.json` schema and delivery mechanics live in ${CLAUDE_PLUGIN_ROOT}/skills/anthropic-docs/references/plugins-reference.md § Monitors.
