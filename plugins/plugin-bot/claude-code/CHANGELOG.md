...
- Bodies diverge per host by design, so the ledger checks currency rather than identity. Byte-identity is asserted only for the bundled scripts and templates, which are copied rather than re-authored. [#69][#69]

### Thanks

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#69]: https://github.com/spencerbeggs/bot/pull/69
